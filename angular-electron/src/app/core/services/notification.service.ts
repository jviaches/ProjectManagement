...
export class NotificationService {
  ...
  public showActionConfirmationSuccess(text: string): void  {
    this.snackConfig.panelClass = ["snackBar-success-style"];
    this.snackBar.open(text, null, this.snackConfig);
  }

  public showActionConfirmationWarning(text: string): void {
    this.snackConfig.panelClass = ["snackBar-warning-style"];
    this.snackBar.open(text, null, this.snackConfig);
  }

  public showActionConfirmationFail(text: string): void {
  ...
  public showModalMessage(
    ...
    dialogConfig.autoFocus = true;
    dialogConfig.data = {
      data: { message: textMessage, caption: textCaption },
    };
